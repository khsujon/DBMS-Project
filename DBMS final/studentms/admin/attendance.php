          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Attendance</h4>
                    ...
                    <form action="attendance_core.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="student_status" value="" class="form-control" required='true'>
                      </div>
            ...
            <div class="row">
                ...
                <div class='col-12 grid-margin stretch-card card'>
                    <h4 class="text-center py-2">Attendance Record</h4>
                    <table class="table">
                    <thead>
                        <tr>
                    ...
                    <td><a onclick="alert('Are U Sure?')" href="attendance_delete_core.php?id=<?php echo $row['id']?>"><i class="icon-trash"></i></a></td>
                    </tr>
